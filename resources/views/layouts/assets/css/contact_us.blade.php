<style>
    ...
    section.contact_form_section .section_title h1 {
        font-size: 40px;
        font-weight: 700;
        color: Blue;
        margin-bottom: 10px;
    ...
    section.contact_form_section .section_title h1 span {
        color: #391E6C;
    }
    ...
    section.contact_form_section.mb-5 h5 {
        color: rgb(98, 93, 93);
        font-size: 20px;
        line-height: 29px;
    }
